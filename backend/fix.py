...
# Using regex to find everything from `prompt_text = (` up to `return PromptTemplate...`
content = re.sub(r'prompt_text = \(\n.*?\n        return PromptTemplate.from_template\(prompt_text\)', new_prompt, content, flags=re.DOTALL)
